(function () {
    ...
    angular.module('app.services')
        .service('VoucherProductService', VoucherProductService);

    /** @ngInject */
    function VoucherProductService($resource, RestService) {

        var resourceURI = RestService.getURI() + 'voucher-products/:id';
