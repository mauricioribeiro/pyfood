    ...
    function DashboardCtrl($scope) {
        ...
        $scope.combo.options = {
            legend: {
                ...
                x: 'right',
                y: 'top',
                data: ['Crédito', 'Débito', 'Parcelado', 'Voucher']
            },            
            grid: {
                x: 40,
                y: 60,
            ...
            series: [
                {
                    ...
                    data:[0,12,24,32,73,50,31,56,70,63,49,72,76,67,46,51,69,59,85,67,56],
                    symbol: 'none',
                ...
                },
                {
                    ...
                    data:[75,62,45,60,73,50,31,23,16,2,81,72,76,67,46,51,69,59,85,67,56],
                    symbol: 'none',
                    legendHoverLink: false,
                    z: 2
                },
            ...
            series : [
                {
                    ...
                    data : [
                        {name:'Ativas', value:36, itemStyle : labelTop},
                        {name:'Inativos', value:64, itemStyle : labelBottom}
                    ]
                },{
                    type : 'pie',
                    center : ['37.5%', '50%'],
                    ...
                    itemStyle : labelFromatter,
                    data : [
                        {name:'Ativos', value:45, itemStyle : labelTop},
                        {name:'Inativos', value:55, itemStyle : labelBottom}
                    ]
                },{
                    type : 'pie',
                    center : ['62.5%', '50%'],
                    ...
                    itemStyle : labelFromatter,
                    data : [
                        {name:'Em Andamento', value:25, itemStyle : labelTop},
                        {name:'Outras', value:75, itemStyle : labelBottom}
                    ]
                },{
                    type : 'pie',
                    center : ['87.5%', '50%'],
                    ...
                    itemStyle : labelFromatter,
                    data : [
                        {name:'Em Andamento', value:75, itemStyle : labelTop},
                        {name:'Outras', value:25, itemStyle : labelBottom}
                    ]
                }
            ]
        };
